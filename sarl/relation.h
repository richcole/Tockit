...
extern struct Sarl_Relation *sarl_relation_copy(
  struct Sarl_RelationIterator *);

extern void sarl_relation_insert(
  struct Sarl_Relation *, Sarl_Index, Sarl_Index);

extern void sarl_relation_remove(
  struct Sarl_Relation *, Sarl_Index, Sarl_Index);

extern void sarl_relation_insert_pair(
