...
\begin{itemstep}
 ...
 \item A ``Formal Concept'' is a pair of a subset of the objects and a
       subset of the attributes where the objects are all those objects
       common to the attributes and vice versa
 \item All formal concepts of a contexts form a lattice regarding the
       subconcept relation defined by the subset relation on the
       object sets (alternatively the superset relation on the attributes)
\end{itemstep}
\end{slide}
}
