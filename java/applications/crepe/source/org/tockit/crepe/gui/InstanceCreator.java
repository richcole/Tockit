...
public class InstanceCreator extends JDialog {
    private static InstanceCreator dialog = null;
    public static String newType = null;

    private InstanceCreator(Frame frame) {
        super(frame, true);
        JLabel mainLabel = new JLabel();
        mainLabel.setText("Name new instance:");
    ...
    protected void closeDialog() {
        InstanceCreator.dialog.setVisible(false);
        ConfigurationManager.storePlacement("InstanceCreator", this);
    }

    public static void initialize(Component comp) {
        Frame frame = JOptionPane.getFrameForComponent(comp);
        dialog = new InstanceCreator(frame);
    }

    public static String createNewInstanceName(Component comp) {
        initialize(comp);
        dialog.setLocationRelativeTo(comp);
        ConfigurationManager.restorePlacement("InstanceCreator", dialog,
